import { addStrengthInputHTML, Strengths, /*strengthsList,*/ updateStrengthsDisplay } from "./S&S/strengths_class.js";
...
function createEventListener() {
  document.querySelector('.js-create-button')
    .addEventListener('click', () => {
      ...
      const descriptionInput = document.querySelector('.js-strength-description-box');
